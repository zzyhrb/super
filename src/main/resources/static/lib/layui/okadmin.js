...
layui.use(["okTab", "okLayer", "jQContextMenu", "jquery"], function () {
    var $ = layui.jquery;
    var okLayer = layui.okLayer;

    var okTab = layui.okTab({
        // 菜单请求路径
        url: "/authority/role/menu/list",
        // 允许同时选项卡的个数
        openTabNum: 30,
        ...
        parseData: function (result) {
            if (result.code === '0') {
                ...
                //             , icon: menu.icon
                //             , spread: menu.title === '控制台'
                //             , isCheck: menu.title === '控制台'
                //             , children: []
                //         });
                //     }
                // });
                // // $(result.data).each(function (i,menu) {
                //     console.log(menu)
                //     if (menu.parentId !== 0) {
                //         $(menu.parentMenu).each(function (j,parentMenu) {
    ...
    $("#switchUser").click(function () {
        ...
        okLayer.open("切换用户", "/user/switch/user", "25%", "33%", null, function () {
        })
    });
    ...
    console.log("        __                         .___      .__        \n" +
        ...
        "" +
        "版本：v2.0\n" +
        "© newgrand.cn All Rights Reserved.\n" +
        "描述：黑龙江省总工会直属事业单位监督分析系统");
});
